...
const ReportDetails = ({ match }) => {
  ...
  const { singleReportValue } = useContext(DataContext);
  const [singleReport, setSingleReport] = singleReportValue;
  ...
  const finalPrice = singleReport.map((x) => {
    return x.finalPrice;
  });
    ...
    <Fragment>
      ...
      <div id="printarea" className="mt-4">
        {singleReport.map((report) => (
          <Card key={singleReport._id} className="mb-3 shadow bg-white rounded">
            <div id="capture">
              <CardHeader>
                ...
                <div className="block">
                  ...
                  <div className="flexbetween">
                    <span>Order Id :</span>
                    <span>{report.oId}</span>
                  </div>
                  <div className="flexbetween">
                    <span> Order Type :</span>
                    <span>{report.tableName}</span>
                  </div>
                  <div className="flexbetween">
                  ...
                  {userData.adminCheck === false ? (
                    <div>
                      ...
                      <div className="flexbetween">
                        ...
                        <span>{report.customerContact}</span>
                      </div>
                    </div>
                  ) : null}
